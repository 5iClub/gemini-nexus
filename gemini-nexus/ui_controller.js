...
// ui_controller.js
import { ChatController } from './ui_chat.js';
import { SidebarController } from './ui_sidebar.js';
import { SettingsController } from './ui_settings.js';
import { ViewerController } from './ui_viewer.js';
...
export class UIController {
    ...
    // Viewer
    openImageViewer(src) { this.viewer.open(src); }
    closeImageViewer() { this.viewer.close(); }
}
